...
class MockDataService {
  ...
  static const double _baseHeartRate = 75.0;
  ...
  static const double _temperatureVariation = 0.5;
  // static const double _systolicBPVariation = 10.0;
  // static const double _diastolicBPVariation = 8.0;
  static const double _glucoseVariation = 10.0;
  ...
  VitalSigns generateEmergencyScenario(EmergencyType type) {
    ...
    switch (type) {
      case EmergencyType.highGlucose:
        return VitalSigns(
          ...
          temperature: 37.1,
          glucose: 165.0, // Dangerously high
  ...
  List<Alert> generateAlertHistory({int days = 30}) {
    ...
    for (int i = 0; i < days; i++) {
      ...
      if (random.nextDouble() < 0.3) {
        // 30% chance of alert per day
        final alertTypes = [
          (
            AlertType.vitalSigns,
            AlertSeverity.info,
            'Blood pressure reading recorded',
            'Your blood pressure of 118/75 mmHg is within normal range.'
          ),
          (
            AlertType.recommendation,
            AlertSeverity.info,
            'Daily hydration reminder',
            'Don\'t forget to drink plenty of water today. Aim for 8-10 glasses.'
          ),
          (
            AlertType.achievement,
            AlertSeverity.info,
            'Weekly milestone reached',
            'Congratulations! You\'ve completed another healthy week of pregnancy.'
          ),
          (
            AlertType.appointment,
            AlertSeverity.warning,
            'Upcoming appointment',
            'Your prenatal checkup is scheduled for tomorrow at 2:00 PM.'
          ),
          (
            AlertType.vitalSigns,
            AlertSeverity.warning,
            'Heart rate slightly elevated',
            'Your heart rate was 105 bpm. Consider resting and monitoring.'
          ),
        ];
        ...
        alerts.add(Alert(
          ...
          actionText:
              alertData.$2 == AlertSeverity.warning ? 'View Details' : null,
        ));
      }
    }
    ...
    alerts.addAll([
      Alert(
        ...
        title: 'Glucose level spike detected',
        message:
            'Your glucose level reading of 150 mg/dL is concerning. Please contact your healthcare provider.',
      ...
      Alert(
        ...
        message:
            'Your wearable device is now connected and monitoring your vital signs.',
        isRead: true,
      ),
    ]);
  ...
  List<HealthRecommendation> generateHealthRecommendations() {
    ...
    return [
      HealthRecommendation(
        ...
        description:
            'Based on your recent blood work, consider adding more iron-rich foods like spinach, lean meat, and lentils to prevent anemia during pregnancy.',
      ...
      HealthRecommendation(
        ...
        description:
            '10-15 minutes of gentle prenatal yoga can help reduce back pain and improve flexibility. Perfect for your current trimester.',
      ...
      HealthRecommendation(
        ...
        description:
            'Aim for 8-10 glasses of water daily. Proper hydration helps prevent constipation and supports increased blood volume.',
      ...
      HealthRecommendation(
        ...
        description:
            'Sleeping on your left side improves blood flow to your baby. Use a pregnancy pillow for extra comfort.',
      ...
      HealthRecommendation(
        ...
        description:
            'Consider enrolling in childbirth classes. Understanding the labor process can help reduce anxiety and prepare you for delivery.',
  ...
  PregnancyTimeline generatePregnancyTimeline() {
    ...
    final edd =
        lmp.add(const Duration(days: 280)); // Estimated due date (40 weeks)
  ...
  List<PregnancyMilestone> _generateMilestones(int currentWeek) {
    final milestones = <PregnancyMilestone>[
      PregnancyMilestone(
        ...
        completedAt: currentWeek > 8
            ? DateTime.now().subtract(Duration(days: (currentWeek - 8) * 7))
            : null,
      ),
      PregnancyMilestone(
        id: 'milestone-002',
        ...
        completedAt: currentWeek > 12
            ? DateTime.now().subtract(Duration(days: (currentWeek - 12) * 7))
            : null,
      ),
      PregnancyMilestone(
        id: 'milestone-003',
        ...
        completedAt: currentWeek > 16
            ? DateTime.now().subtract(Duration(days: (currentWeek - 16) * 7))
            : null,
      ),
      PregnancyMilestone(
        id: 'milestone-004',
        ...
        completedAt: currentWeek > 20
            ? DateTime.now().subtract(Duration(days: (currentWeek - 20) * 7))
            : null,
      ),
      PregnancyMilestone(
        id: 'milestone-006',
        ...
        completedAt: currentWeek >= 28
            ? DateTime.now().subtract(Duration(days: (currentWeek - 28) * 7))
            : null,
      ),
  ...
  List<WeeklyUpdate> _generateWeeklyUpdates() {
    return [
      const WeeklyUpdate(
        ...
        motherChanges:
            'You may notice increased fatigue and some difficulty sleeping. Your belly is growing more noticeable, and you might experience mild back pain.',
        babyDevelopment:
            'Your baby\'s eyes can now open and close, and they\'re developing fat layers under their skin. Their brain is developing rapidly.',
        tips: [
        ...
        appointments: ['Regular prenatal checkup', 'Blood pressure monitoring'],
      ),
      const WeeklyUpdate(
        id: 'week-29',
        week: 29,
        ...
        motherChanges:
            'Your uterus is expanding, which may cause some shortness of breath. You might also notice more frequent urination.',
        babyDevelopment:
            'Your baby\'s bones are hardening, and their movements are becoming more pronounced. They\'re practicing breathing movements.',
        tips: [
        ...
        appointments: ['Monthly prenatal checkup', 'Blood pressure monitoring'],
      ),
    ];
  }
