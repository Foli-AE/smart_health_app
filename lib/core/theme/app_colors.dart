...
class AppColors {
  ...
  static const Color primary =
      Color(0xFF4CAF50); // Calming green for normal status
  ...
  static const Color success =
      Color(0xFF4CAF50); // Same as primary for consistency
  static const Color warning = Color(0xFFFF9800); // Warm amber for caution
  static const Color error =
      Color(0xFFE57373); // Gentle red, less alarming than typical red
  ...
  static const Color oxygenSaturation =
      Color(0xFF2196F3); // Blue for oxygen saturation
